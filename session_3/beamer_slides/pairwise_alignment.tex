...
\subtitle{optimal alignment by dynamic programming}
\author{Martin Jakt}
  ...
  \begin{figure}[ht]
    \begin{tikzpicture}[scale=0.5]
      ...
      \visible<4->{
        ...
        \node [right, font=\ttfamily] at (11.,7.8)  {-CATTA--}; 
...
\begin{frame}{Different types of alignment (2)}
  ...
  \item[others] Differential treatment of internal and terminal gaps.
  \end{description}
\end{frame}
...
\begin{frame}{Dotplot: finding a path}
  \begin{figure}[ht]
    \begin{tikzpicture}[scale=0.35]
      \input{dplot_2.tikz}
      \visible<2-6>{
        \node [below,right,text width=5cm,fill=black!10] at (13,13)
              {How many different paths can we follow to connect the top left
